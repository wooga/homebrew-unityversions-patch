cask 'unity-standardassets@2017.2.0p3' do
  version '2017.2.0p3,40117ac43b95'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/40117ac43b95/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.0p3/Standard Assets'
end
