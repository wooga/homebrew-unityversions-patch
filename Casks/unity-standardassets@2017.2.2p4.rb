cask 'unity-standardassets@2017.2.2p4' do
  version '2017.2.2p4,a30add86d148'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/a30add86d148/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.2p4/Standard Assets'
end
