cask 'unity-windows-support-for-editor@5.5.2p1' do
  ...
  url "https://download.unity3d.com/download_unity/9360c5517afe/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-5.5.2p1.pkg"
  name 'Windows Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Windows-Support-for-Editor-5.5.2p1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.5.2p1/PlaybackEngines/WindowsStandaloneSupport'
end
