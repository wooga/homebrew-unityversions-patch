cask 'unity-standardassets@2017.2.2p2' do
  version '2017.2.2p2,32bc645ba6f6'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/32bc645ba6f6/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.2p2/Standard Assets'
end
