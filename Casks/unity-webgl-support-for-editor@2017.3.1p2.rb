cask 'unity-webgl-support-for-editor@2017.3.1p2' do
  ...
  url "https://download.unity3d.com/download_unity/fd9fec26f216/MacEditorTargetInstaller/UnitySetup-WebGL-Support-for-Editor-2017.3.1p2.pkg"
  name 'WebGL Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-WebGL-Support-for-Editor-2017.3.1p2.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.1p2/PlaybackEngines/WebGLSupport'
end
