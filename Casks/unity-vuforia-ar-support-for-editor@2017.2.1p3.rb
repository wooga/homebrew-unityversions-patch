cask 'unity-vuforia-ar-support-for-editor@2017.2.1p3' do
  version '2017.2.1p3,273860332f50'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/273860332f50/MacEditorTargetInstaller/UnitySetup-Vuforia-AR-Support-for-Editor-2017.2.1p3.pkg"
  name 'Vuforia Augmented Reality Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Vuforia-AR-Support-for-Editor-2017.2.1p3.pkg'
