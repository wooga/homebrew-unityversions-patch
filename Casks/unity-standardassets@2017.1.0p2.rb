cask 'unity-standardassets@2017.1.0p2' do
  version '2017.1.0p2,31954117ff6c'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/31954117ff6c/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0p2/Standard Assets'
end
