cask 'unity-standardassets@2017.1.4p1' do
  version '2017.1.4p1,644977348e46'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/644977348e46/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.4p1/Standard Assets'
end
