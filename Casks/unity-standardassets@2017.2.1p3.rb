cask 'unity-standardassets@2017.2.1p3' do
  version '2017.2.1p3,273860332f50'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/273860332f50/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.1p3/Standard Assets'
end
