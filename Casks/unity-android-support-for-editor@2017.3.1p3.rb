cask 'unity-android-support-for-editor@2017.3.1p3' do
  ...
  url "https://download.unity3d.com/download_unity/a66397957d3b/MacEditorTargetInstaller/UnitySetup-Android-Support-for-Editor-2017.3.1p3.pkg"
  name 'Android Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Android-Support-for-Editor-2017.3.1p3.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.1p3/PlaybackEngines/AndroidPlayer'
end
