cask 'unity-standardassets@2017.1.4p2' do
  version '2017.1.4p2,490bad3999ec'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/490bad3999ec/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.4p2/Standard Assets'
end
