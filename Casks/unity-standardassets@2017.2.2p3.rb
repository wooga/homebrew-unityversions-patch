cask 'unity-standardassets@2017.2.2p3' do
  version '2017.2.2p3,7706f9f606ca'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/7706f9f606ca/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.2p3/Standard Assets'
end
