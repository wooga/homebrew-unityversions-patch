cask 'unity-standardassets@2017.2.2p1' do
  version '2017.2.2p1,31794ac12ad1'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/31794ac12ad1/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.2p1/Standard Assets'
end
