cask 'unity-standardassets@2017.2.1p4' do
  version '2017.2.1p4,1992a1ed2d78'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/1992a1ed2d78/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.1p4/Standard Assets'
end
