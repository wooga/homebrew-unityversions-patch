cask 'unity-android-support-for-editor@5.6.0p3' do
  ...
  url "https://download.unity3d.com/download_unity/f8dcc233883f/MacEditorTargetInstaller/UnitySetup-Android-Support-for-Editor-5.6.0p3.pkg"
  name 'Android Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Android-Support-for-Editor-5.6.0p3.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.0p3/PlaybackEngines/AndroidPlayer'
end
