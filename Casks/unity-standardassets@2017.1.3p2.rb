cask 'unity-standardassets@2017.1.3p2' do
  version '2017.1.3p2,744dab055778'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/744dab055778/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.3p2/Standard Assets'
end
