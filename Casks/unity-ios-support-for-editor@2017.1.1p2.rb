cask 'unity-ios-support-for-editor@2017.1.1p2' do
  ...
  url "https://download.unity3d.com/download_unity/b8e3f2d6c409/MacEditorTargetInstaller/UnitySetup-iOS-Support-for-Editor-2017.1.1p2.pkg"
  name 'iOS Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-iOS-Support-for-Editor-2017.1.1p2.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.1p2/PlaybackEngines/iOSSupport'
end
