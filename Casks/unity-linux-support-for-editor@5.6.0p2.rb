cask 'unity-linux-support-for-editor@5.6.0p2' do
  ...
  url "https://download.unity3d.com/download_unity/bbd5ca01a0ea/MacEditorTargetInstaller/UnitySetup-Linux-Support-for-Editor-5.6.0p2.pkg"
  name 'Linux Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Linux-Support-for-Editor-5.6.0p2.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.0p2/PlaybackEngines/LinuxStandaloneSupport'
end
