cask 'unity-standardassets@2017.1.3p3' do
  version '2017.1.3p3,fc055e6cd68b'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/fc055e6cd68b/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.3p3/Standard Assets'
end
