cask 'unity-windows-support-for-editor@5.6.3p4' do
  ...
  url "https://download.unity3d.com/download_unity/fbe8bd37d7fa/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-5.6.3p4.pkg"
  name 'Windows Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Windows-Support-for-Editor-5.6.3p4.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.3p4/PlaybackEngines/WindowsStandaloneSupport'
end
