cask 'unity-standardassets@2017.2.3p4' do
  version '2017.2.3p4,2f2d0e6b4eb5'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/2f2d0e6b4eb5/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.3p4/Standard Assets'
end
