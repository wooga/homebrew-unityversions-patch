cask 'unity-standardassets@2017.2.3p3' do
  version '2017.2.3p3,726d0db4eeac'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/726d0db4eeac/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.3p3/Standard Assets'
end
