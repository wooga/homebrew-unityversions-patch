cask 'unity-webgl-support-for-editor@5.5.3p2' do
  ...
  url "https://download.unity3d.com/download_unity/f15b2772e4d0/MacEditorTargetInstaller/UnitySetup-WebGL-Support-for-Editor-5.5.3p2.pkg"
  name 'WebGL Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-WebGL-Support-for-Editor-5.5.3p2.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.5.3p2/PlaybackEngines/WebGLSupport'
end
