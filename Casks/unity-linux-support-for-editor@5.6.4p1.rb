cask 'unity-linux-support-for-editor@5.6.4p1' do
  ...
  url "https://download.unity3d.com/download_unity/e67c4b7007d5/MacEditorTargetInstaller/UnitySetup-Linux-Support-for-Editor-5.6.4p1.pkg"
  name 'Linux Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Linux-Support-for-Editor-5.6.4p1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.4p1/PlaybackEngines/LinuxStandaloneSupport'
end
