cask 'unity-standardassets@2017.2.1p1' do
  version '2017.2.1p1,edf5bdf50eb0'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/edf5bdf50eb0/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.1p1/Standard Assets'
end
