cask 'unity-standardassets@2017.1.1p3' do
  version '2017.1.1p3,929150d2fa14'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/929150d2fa14/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.1p3/Standard Assets'
end
