cask 'unity-standardassets@2017.3.1p4' do
  version '2017.3.1p4,7f25373c3e03'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/7f25373c3e03/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.1p4/Standard Assets'
end
