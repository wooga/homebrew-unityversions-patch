cask 'unity-standardassets@2017.1.1p4' do
  version '2017.1.1p4,4b0ddcd3f6ad'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/4b0ddcd3f6ad/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.1p4/Standard Assets'
end
