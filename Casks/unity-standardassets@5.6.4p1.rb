cask 'unity-standardassets@5.6.4p1' do
  version '5.6.4p1,e67c4b7007d5'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/e67c4b7007d5/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.4p1/Standard Assets'
end
