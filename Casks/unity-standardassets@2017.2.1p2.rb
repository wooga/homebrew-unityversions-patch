cask 'unity-standardassets@2017.2.1p2' do
  version '2017.2.1p2,1dc514532f08'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/1dc514532f08/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.1p2/Standard Assets'
end
