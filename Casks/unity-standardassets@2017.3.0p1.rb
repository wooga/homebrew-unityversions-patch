cask 'unity-standardassets@2017.3.0p1' do
  version '2017.3.0p1,4596dd67072f'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/4596dd67072f/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0p1/Standard Assets'
end
