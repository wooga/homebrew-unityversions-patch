cask 'unity-standardassets@2017.3.0p4' do
  version '2017.3.0p4,25a5860ad58d'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/25a5860ad58d/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0p4/Standard Assets'
end
