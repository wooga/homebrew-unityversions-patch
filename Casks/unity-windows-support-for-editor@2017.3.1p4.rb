cask 'unity-windows-support-for-editor@2017.3.1p4' do
  ...
  url "https://download.unity3d.com/download_unity/7f25373c3e03/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-2017.3.1p4.pkg"
  name 'Windows Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Windows-Support-for-Editor-2017.3.1p4.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.1p4/PlaybackEngines/WindowsStandaloneSupport'
end
