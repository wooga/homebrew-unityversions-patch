cask 'unity-standardassets@2017.1.0p3' do
  version '2017.1.0p3,0f0686ba7d25'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/0f0686ba7d25/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0p3/Standard Assets'
end
