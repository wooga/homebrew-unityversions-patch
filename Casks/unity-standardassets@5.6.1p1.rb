cask 'unity-standardassets@5.6.1p1' do
  version '5.6.1p1,74c1f4917542'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/74c1f4917542/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.1p1/Standard Assets'
end
