cask 'unity-linux-support-for-editor@2017.3.1p3' do
  ...
  url "https://download.unity3d.com/download_unity/a66397957d3b/MacEditorTargetInstaller/UnitySetup-Linux-Support-for-Editor-2017.3.1p3.pkg"
  name 'Linux Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Linux-Support-for-Editor-2017.3.1p3.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.1p3/PlaybackEngines/LinuxStandaloneSupport'
end
